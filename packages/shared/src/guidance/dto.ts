...
export const PRODUCT_EVENTS = [
  ...
  "FINANCING_DATA_REQUEST_CREATED",
  "FINANCING_DATA_REQUEST_SENT",
  "FINANCING_DATA_REQUEST_OPENED",
  "FINANCING_DATA_REQUEST_STARTED",
  "FINANCING_DATA_REQUEST_SUBMITTED",
  "FINANCING_DATA_CORRECTION_REQUESTED",
  "FINANCING_DATA_APPROVED_FOR_SIMULATION",
  "FINANCING_DATA_REQUEST_EXPIRED",
  "FINANCING_DATA_REQUEST_REVOKED",
] as const;
